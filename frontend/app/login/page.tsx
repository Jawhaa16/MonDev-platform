            ...
            <main className="min-h-screen bg-black pt-24 pb-12 px-4">
                <div className="max-w-md mx-auto">
                    <div className="text-center mb-8">
                        <h1 className="text-4xl font-bold mb-4">Нэвтрэх</h1>
                        <p className="text-gray-400">
                            MonDev.mn-д тавтай морилно уу
                        </p>
                    </div>
                    ...
                    <Card>
                        <div className="space-y-6">
                            ...
                            <div className="text-center text-sm text-gray-400">
                                <p>
                                    Бүртгэлгүй юу?{' '}
                                    <Link href="/register" className="text-accent hover:text-blue-400 font-semibold">
                                        Бүртгүүлэх
                                    </Link>
                                </p>
                            </div>
